...
def esm2_new(protein_name="6dql", path_pdbs = '/cm/shared/duynvt3/Molecule_Generation/Drug_repurposing/DrugBank/pdb'):
    protein_path = os.path.join(path_pdbs, f"{protein_name}.pdb")
...
def get_simulate_data(args, protein_name = '1a01', database="drugbank", group = "train"):
    protein_node_xyz, protein_esm2_feat = esm2_new(protein_name, path_pdbs = '/cm/shared/duynvt3/Molecule_Generation/Drug_repurposing/DrugBank/pdb')
    
    compound_conformer_id = 0
    df = pd.read_csv(f"/cm/shared/duynvt3/Molecule_Generation/Drug_repurposing/DrugBank/data/{database}.csv")
    compound_lst = glob(
        f"/cm/shared/duynvt3/Molecule_Generation/Drug_repurposing/DrugBank/ligands_conformation/stage_1/{protein_name}_{database}_binding_ligands/*.pdb"
    )
