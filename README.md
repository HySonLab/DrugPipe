...
The results are organized in the `assets` folder with the following subdirectories:
...
- **q_vinaw**: Stores the results produced by the `q_vinaw` method for the case studies.
- **drug_similarity**: Contains drug similarity comparisons between real drugs and others, based on various search algorithms.
